...
struct Statics {
    ...
    public static let imagePrefix: String = "/test/image.php?text="

    public static let baseUrl: String = "dev.tapptic.com"
    public static let imagesBaseUrl: String = "inu.tapptic.com"
    public static let url: String = "\(prefix)\(baseUrl)"
    public static let imagesUrl: String = "\(prefix)\(imagesBaseUrl)\(imagePrefix)"

    public static let devTappticKey: String = "devTapptic"
    ...
    public static let imageKey: String = "image"
